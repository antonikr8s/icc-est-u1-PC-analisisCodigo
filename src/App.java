public class App {
    public static void main(String[] args) {
         ...
         * 
         * /// Consejo descomentar metodo por metodo para que puedan ir provando cada
         * uno
         ...
         * ordenador.burbujaTradicional(arregloBurbuja.clone());
         * System.out.println(
         ...
         * ordenador.burbujaTradicionalSegundo(arregloBurbuja.clone());
         * System.out.println(
